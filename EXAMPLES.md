...
[Approov](https://approov.io) is an API security solution used to verify that requests received by your backend services originate from trusted versions of your mobile apps, and here you can find the Hello servers examples that are the base for the Approov [quickstarts](/docs) for Python.
...
If you are looking for the Approov quickstarts to integrate Approov in your Python API server then you can find them [here](/QUICKSTARTS.md).
